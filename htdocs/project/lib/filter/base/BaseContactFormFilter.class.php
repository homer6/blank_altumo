...
abstract class BaseContactFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'mailing_address_latitude'  => new sfWidgetFormFilterInput(),
      'mailing_address_longitude' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'mailing_address_latitude'  => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'mailing_address_longitude' => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
  ...
  public function getFields()
  {
    return array(
      ...
      'mailing_address_latitude'  => 'Number',
      'mailing_address_longitude' => 'Number',
      'city'                      => 'Text',
      'state_id'                  => 'ForeignKey',
      'zip_code'                  => 'Text',
      'created_at'                => 'Date',
