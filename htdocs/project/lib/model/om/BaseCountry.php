 ...
 */
abstract class BaseCountry extends BaseObject 
{
    ...
    /**
     * The value for the demonym field.
     * @var        string
     */
    protected $demonym;
    ...
    /**
     * Set the value of [demonym] column.
     * 
     * @param      string $v new value
     * @return   Country The current object (for fluent API support)
     */
    public function setDemonym($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->demonym !== $v) {
            $this->demonym = $v;
            $this->modifiedColumns[] = CountryPeer::DEMONYM;
        }
    ...
    public function setDefaultCurrencyId($v)
    {
        ...
        if ($this->default_currency_id !== $v) {
            ...
            $this->modifiedColumns[] = CountryPeer::DEFAULT_CURRENCY_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->demonym = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->default_currency_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            $this->resetModified();
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[4] => $this->getDemonym(),
            $keys[5] => $this->getDefaultCurrencyId(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setDemonym($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setDefaultCurrencyId($arr[$keys[5]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CountryPeer::DEMONYM)) $criteria->add(CountryPeer::DEMONYM, $this->demonym);
        if ($this->isColumnModified(CountryPeer::DEFAULT_CURRENCY_ID)) $criteria->add(CountryPeer::DEFAULT_CURRENCY_ID, $this->default_currency_id);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setDemonym($this->getDemonym());
    ...
    {
        $this->statesScheduledForDeletion = $this->getStates(new Criteria(), $con)->diff($states);

        foreach ($this->statesScheduledForDeletion as $stateRemoved) {
