...
abstract class BaseCurrencyPeer {
    ...
    const ISO_CODE = 'currency.ISO_CODE';

    /** the column name for the ISO_NUMBER field */
    const ISO_NUMBER = 'currency.ISO_NUMBER';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'IsoCode', 'IsoNumber', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'isoCode', 'isoNumber', ),
        BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::ISO_CODE, self::ISO_NUMBER, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'ISO_CODE', 'ISO_NUMBER', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'iso_code', 'iso_number', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'IsoCode' => 2, 'IsoNumber' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'isoCode' => 2, 'isoNumber' => 3, ),
        BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::ISO_CODE => 2, self::ISO_NUMBER => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'ISO_CODE' => 2, 'ISO_NUMBER' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'iso_code' => 2, 'iso_number' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CurrencyPeer::ISO_CODE);
            $criteria->addSelectColumn(CurrencyPeer::ISO_NUMBER);
        } else {
            $criteria->addSelectColumn($alias . '.ID');
            $criteria->addSelectColumn($alias . '.NAME');
            $criteria->addSelectColumn($alias . '.ISO_CODE');
            $criteria->addSelectColumn($alias . '.ISO_NUMBER');
        }
    }
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += CurrencyPeer::doOnDeleteCascade($c, $con);
