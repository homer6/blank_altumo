 ...
 */
abstract class BaseSystemEventInstance extends BaseObject 
{
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = SystemEventInstanceQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SystemEventInstancePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(SystemEventInstancePeer::SYSTEM_EVENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`SYSTEM_EVENT_ID`';
        }
        if ($this->isColumnModified(SystemEventInstancePeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`USER_ID`';
        }
        if ($this->isColumnModified(SystemEventInstancePeer::MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '`MESSAGE`';
        }
        if ($this->isColumnModified(SystemEventInstancePeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`CREATED_AT`';
        }
        if ($this->isColumnModified(SystemEventInstancePeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`UPDATED_AT`';
        }

        $sql = sprintf(
            'INSERT INTO `system_event_instance` (%s) VALUES (%s)',
    ...
    public function setSystemEventInstanceMessages(PropelCollection $systemEventInstanceMessages, PropelPDO $con = null)
    {
        ...
        foreach ($this->systemEventInstanceMessagesScheduledForDeletion as $systemEventInstanceMessageRemoved) {
            $systemEventInstanceMessageRemoved->setSystemEventInstance(null);
        }
