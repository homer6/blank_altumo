...
abstract class BaseUserPeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'PasswordResetKey', 'SfGuardUserId', 'ContactId', 'Active', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'passwordResetKey', 'sfGuardUserId', 'contactId', 'active', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PASSWORD_RESET_KEY, self::SF_GUARD_USER_ID, self::CONTACT_ID, self::ACTIVE, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PASSWORD_RESET_KEY', 'SF_GUARD_USER_ID', 'CONTACT_ID', 'ACTIVE', 'CREATED_AT', 'UPDATED_AT', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'password_reset_key', 'sf_guard_user_id', 'contact_id', 'active', 'created_at', 'updated_at', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'PasswordResetKey' => 1, 'SfGuardUserId' => 2, 'ContactId' => 3, 'Active' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'passwordResetKey' => 1, 'sfGuardUserId' => 2, 'contactId' => 3, 'active' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PASSWORD_RESET_KEY => 1, self::SF_GUARD_USER_ID => 2, self::CONTACT_ID => 3, self::ACTIVE => 4, self::CREATED_AT => 5, self::UPDATED_AT => 6, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'PASSWORD_RESET_KEY' => 1, 'SF_GUARD_USER_ID' => 2, 'CONTACT_ID' => 3, 'ACTIVE' => 4, 'CREATED_AT' => 5, 'UPDATED_AT' => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'password_reset_key' => 1, 'sf_guard_user_id' => 2, 'contact_id' => 3, 'active' => 4, 'created_at' => 5, 'updated_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(UserPeer::CONTACT_ID);
	...
	public static function doCountJoinContact(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(UserPeer::CONTACT_ID, ContactPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of User objects pre-filled with their Contact objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinContact(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (User) to $obj2 (Contact)
				$obj2->addUser($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (User) to the collection in $obj2 (Contact)
				$obj2->addUser($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (User) to the collection in $obj3 (sfGuardUser)
				$obj3->addUser($obj1);
			} // if joined row not null
	...
	/**
	 * Selects a collection of User objects pre-filled with all related objects except Contact.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of User objects pre-filled with all related objects except sfGuardUser.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	{
	  return array(array('password_reset_key'), array('sf_guard_user_id'));
	}
