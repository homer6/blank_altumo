 ...
 * @method     SystemEventSubscription findOneByType(string $type) Return the first SystemEventSubscription filtered by the type column
 ...
 * @method     array findByType(string $type) Return SystemEventSubscription objects filtered by the type column
