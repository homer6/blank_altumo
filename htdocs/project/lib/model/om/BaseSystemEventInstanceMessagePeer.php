...
abstract class BaseSystemEventInstanceMessagePeer {
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = SystemEventInstanceMessagePeer::getOMClass();
    ...
    {
        return SystemEventInstanceMessagePeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a SystemEventInstanceMessage or Criteria object.
     *
    ...
    /**
     * Performs an UPDATE on the database, given a SystemEventInstanceMessage or Criteria object.
     *
    ...
    /**
     * Deletes all rows from the system_event_instance_message table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    /**
     * Performs a DELETE on the database, given a SystemEventInstanceMessage or Criteria object OR a primary key value.
     *
