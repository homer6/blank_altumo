...
class StateTableMap extends TableMap
{
	...
	public function initialize()
	{
		...
		$this->addColumn('ISO_SHORT_CODE', 'IsoShortCode', 'VARCHAR', true, 4, null);
	...
	public function buildRelations()
	{
		...
		$this->addRelation('Contact', 'Contact', RelationMap::ONE_TO_MANY, array('id' => 'state_id', ), 'RESTRICT', null, 'Contacts');
	} // buildRelations()
