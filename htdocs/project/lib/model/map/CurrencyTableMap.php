...
class CurrencyTableMap extends TableMap
{
	...
	public function initialize()
	{
		...
		$this->addColumn('ISO_NUMBER', 'IsoNumber', 'VARCHAR', true, 3, null);
		// validators
	} // initialize()
	...
	{
		$this->addRelation('Country', 'Country', RelationMap::ONE_TO_MANY, array('id' => 'default_currency_id', ), 'CASCADE', null, 'Countrys');
	} // buildRelations()
