...
class SystemEventTableMap extends TableMap
{
	...
	{
		$this->addRelation('SystemEventSubscription', 'SystemEventSubscription', RelationMap::ONE_TO_MANY, array('id' => 'system_event_id', ), 'CASCADE', 'CASCADE', 'SystemEventSubscriptions');
		$this->addRelation('SystemEventInstance', 'SystemEventInstance', RelationMap::ONE_TO_MANY, array('id' => 'system_event_id', ), 'CASCADE', 'CASCADE', 'SystemEventInstances');
	} // buildRelations()
